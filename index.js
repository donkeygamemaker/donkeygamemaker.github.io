...
function init(){
	...
	frenderer=new CSS2DRenderer();
	frenderer.setSize(dww[0],dww[1]);
	frenderer.domElement.style.position="absolute";
	frenderer.domElement.style.top="0";
	document.getElementById("content").appendChild(frenderer.domElement);
